...
const savePhoto = async (img, width) => {
    try {
        //Creamos la ruta absoluta de subida de archivos.
        ...
        //Convertimos la imagen a un objeto tipo Sharp.
        const sharpImg = sharp(img.data);

        //Reedimensionamos la imagen. El parámetro width representa un ancho en píxeles.
